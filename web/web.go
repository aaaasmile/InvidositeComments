...
import (
	...
	"github.com/aaaasmile/InvidositeComments/web/cmt"
)
...
func RunService(configfile string) error {
	...
	if err := cmt.InitFromConfig(conf.Current.DebugVerbose, conf.Current.DBPath); err != nil {
		return err
	}
	...
	http.HandleFunc(conf.Current.RootURLPattern, cmt.APiHandler)
